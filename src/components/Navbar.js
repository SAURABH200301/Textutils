      ...
      <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode}`}>
        <div className="container-fluid">
          ...
          {/* <div>
            ...
            <div>
               <div onClick={()=>{props.setModee('danger')}} className="bg-danger rounded m-1" style={{height:'30px', width:'30px'}}></div>
            </div>
            <div>
...
// isRequired is used to define that these props are nessecary 

// this is deafult props if props is not passed these props will be used 
Navbar.defaultProps = {
  title: 'hey title here',
